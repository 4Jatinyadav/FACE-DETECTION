...
test_img=cv2.imread('G:/FaceRecognition-master/FaceRecognition-master/TestImages/three.jpg')#test_img path
faces_detected,gray_img=fr.faceDetection(test_img)
print("faces_detected:",faces_detected)


#Comment below lines when running this program second time.Since it saves training.yml file in directory
faces,faceID=fr.labels_for_training_data('G:/FaceRecognition-master/FaceRecognition-master/trainingImages')
face_recognizer=fr.train_classifier(faces,faceID)
face_recognizer.write('G:/FaceRecognition-master/FaceRecognition-master/trainingData.yml')


#Uncomment below line for subsequent runs
#face_recognizer=cv2.face.LBPHFaceRecognizer_create()
#face_recognizer.read('G:/FaceRecognition-master/FaceRecognition-master/trainingData.yml')#use this to load training data for subsequent runs
